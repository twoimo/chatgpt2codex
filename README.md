...
The macOS package requires a real Apple code-signing identity and team-scoped keychain entitlements for the Secure Enclave helper; ad-hoc signing is refused for write-capable packaging.
